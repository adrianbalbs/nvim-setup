...
-- Delete buffer
vim.keymap.set("n", "<leader>bd", "<cmd>bd<cr>", { desc = "Go to right window", remap = true })

-- Better indenting in visual mode
vim.keymap.set("v", "<", "<gv")
vim.keymap.set("v", ">", ">gv")

-- Better C-d and C-u motions
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'haskell', 'go', 'latex', 'bibtex' },
...
vim.keymap.set('n', '<leader>gd', vim.diagnostic.open_float, { desc = 'Open floating diagnostic message' })
...
-- Config these servers manually to prevent conflicts, ignore in setting up handlers initially
local ignore_setup = { "hls" }
...
mason_lspconfig.setup_handlers {
  function(server_name)
    if not table_contains(ignore_setup, server_name) then
